...
class CCPUPathTracer
{
	...
	DirectX::XMFLOAT3 Radiance(CLight& sun, bool bGlobalIllumination, long nNumSamples, bool bUseTextures, DirectX::XMVECTOR& rayOrigin, DirectX::XMVECTOR& rayDir, const int& depth, unsigned short* Xi);
