...
4) I have made no attempt to minimuize/optimize instructions and branches in the CUDA code. There is also C++ recurision in the CUDA code which is consdiered inefficient.
