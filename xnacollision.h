...
BOOL IntersectRayTriangle(DirectX::FXMVECTOR Origin, DirectX::XMVECTOR Direction, DirectX::FXMVECTOR V0, DirectX::CXMVECTOR V1, DirectX::CXMVECTOR V2,
                           FLOAT* pDist, FLOAT* nU, FLOAT* nV );
...
BOOL IntersectTriangleTriangle(DirectX::FXMVECTOR A0, DirectX::FXMVECTOR A1, DirectX::FXMVECTOR A2, DirectX::CXMVECTOR B0, DirectX::CXMVECTOR B1, DirectX::CXMVECTOR B2 );
...
//-----------------------------------------------------------------------------
INT IntersectTriangle6Planes(DirectX::FXMVECTOR V0, DirectX::FXMVECTOR V1, DirectX::FXMVECTOR V2, DirectX::CXMVECTOR Plane0, DirectX::CXMVECTOR Plane1,
